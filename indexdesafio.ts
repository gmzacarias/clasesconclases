// la funcion this sirve para leer y guardar
...
class Piso{
    nombre: string;
    // = [] le dice a departamento que se inicialize con un array vacio
    deptos : Departamento[] = [];
...
// ejemplo
// getDepartamentoByPiso(nombreDelPiso:string): Departamento[]{} ,en este ejemplo : sirve para definir que tipo de respuesta/return queremos
// en este caso seria un array de la clase departamentos
